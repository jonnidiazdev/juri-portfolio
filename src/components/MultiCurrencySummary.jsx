...
export default function MultiCurrencySummary({ 
  ...
  return (
    <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6 ${className}`}>
      {/* Totales en ARS */}
      <div className="bg-gradient-to-br from-green-800/20 to-green-900/20 rounded-xl p-4 sm:p-6 border border-green-700/30 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className={`text-base sm:text-xl font-semibold ${isPositiveARS ? 'text-green-400' : 'text-red-400'}`}>
      ...
      {/* Totales en USD */}
      <div className="bg-gradient-to-br from-blue-800/20 to-blue-900/20 rounded-xl p-4 sm:p-6 border border-blue-700/30 shadow-xl">
        <div className="flex items-center gap-3 mb-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className={`text-base sm:text-xl font-semibold ${isPositiveUSD ? 'text-green-400' : 'text-red-400'}`}>
