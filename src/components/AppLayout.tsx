      ...
      <header className="mb-8">
        ...
        {syncError && (
          <div className="status-banner mb-4 bg-peso/10 border border-peso/25 text-peso justify-between">
            <span>{syncError}</span>
            <button onClick={onDismissSyncError} className="text-peso/70 hover:text-peso shrink-0" aria-label="Cerrar aviso">✕</button>
          </div>
        )}
        ...
        {iolAuthError && (
          <div className="status-banner mb-4 bg-loss/10 border border-loss/25 text-loss justify-between">
            ...
            <button onClick={onDismissIolError} className="text-loss/70 hover:text-loss shrink-0" aria-label="Cerrar aviso">✕</button>
          </div>
        )}
      </header>
