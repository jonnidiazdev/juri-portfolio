...
function buildCacheFieldKey(type, key) {
...
export async function saveQuoteCache({ ownerId, type, key, data }) {
...
export async function getQuoteCache({ ownerId, type, key }) {
...
export async function getAllQuoteCache({ ownerId }) {
  if (!ownerId || !isFirebaseConfigured) return {}
